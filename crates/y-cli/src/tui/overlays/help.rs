...
fn help_lines() -> Vec<Line<'static>> {
    ...
    vec![
        ...
        keybinding_line("  Ctrl+H    ", "Show/hide help", key_style, desc_style),
        keybinding_line(
            "  Tab       ",
        ...
        keybinding_line(
            "  Enter     ",
            "Send message / queue follow-up",
            key_style,
            desc_style,
        ),
        keybinding_line("  Shift+Enter", "New line", key_style, desc_style),
        keybinding_line("  : or /    ", "Command palette", key_style, desc_style),
        ...
        keybinding_line("  j/k       ", "Scroll line up/down", key_style, desc_style),
        keybinding_line(
            "  PageUp/Down",
            "Scroll page up/down",
            key_style,
        ...
        keybinding_line("  Up/Down   ", "Navigate commands", key_style, desc_style),
        keybinding_line(
            "  /resume   ",
