...
export function useChat(
  ...
  return useMemo(
    ...
    [
      ...
      streaming.streamingSessionIds,
      streaming.activeRunId,
      messages.error,
      sessionState.opStatus,
      sessionState.pendingEdit,
      streaming.visibleToolResults,
      streaming.getStreamSegments,
      operations.sendMessage,
      operations.cancelRun,
      messages.loadMessages,
      messages.clearMessages,
      operations.editMessage,
      operations.cancelEdit,
      operations.editAndResend,
      operations.undoToMessage,
      operations.resendLastTurn,
