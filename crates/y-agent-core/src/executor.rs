...
use crate::channel::WorkflowContext;
use crate::checkpoint::{ChannelSnapshot, CheckpointStore, TaskOutput, WorkflowCheckpoint};
...
mod tests {
    ...
    fn task(id: &str, deps: &[&str]) -> TaskNode {
        TaskNode {
            id: id.into(),
            name: id.into(),
            priority: crate::dag::TaskPriority::Normal,
    ...
    fn test_execute_simple_dag() {
        ...
        dag.add_task(task("c", &["a"]));
        dag.add_task(task("d", &["b", "c"]));
