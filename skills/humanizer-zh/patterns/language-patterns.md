...
**高频 AI 词汇：** 此外、与……保持一致、至关重要、深入探讨、强调、持久的、增强、培养、获得、突出（动词）、相互作用、复杂/复杂性、关键（形容词）、格局（抽象名词）、关键性的、展示、织锦、证明、强调（动词）、宝贵的、充满活力的
...
**问题：** 像"不仅……而且……"、"这不仅仅是关于……，而是……"、"是……而不是……"这类成对否定式结构被过度使用，常被 LLM 用来制造一种「对比 + 升华」的假深度。
