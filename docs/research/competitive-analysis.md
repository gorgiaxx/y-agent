...
| **Hashline editor**           | Oh-My-OpenCode | Reject        | Line-hash-based edit validation is specific to code editing agents. y-agent is a general-purpose framework; file_write with atomic rename and workspace locking is sufficient.                                        |
