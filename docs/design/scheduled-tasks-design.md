...
|------|----------|---------|---------|
| 2026-03-06 | Integrate with Orchestrator Workflows | Reuse execution infrastructure | Accepted |
| 2026-03-06 | Timer wheel for scheduling | Performance at scale | Accepted |
| 2026-03-06 | Event triggers via Hook System | Avoid duplicate event infrastructure | Accepted |
| 2026-03-06 | Add ParameterSchema (JSON Schema) for parameterized scheduling | Same workflow reusable across schedules with different parameters; validated at bind time; critical for Agent Autonomy (ref: agent-autonomy-design.md) | Accepted |
| 2026-03-06 | Add agent-facing scheduling tools (schedule_create, schedule_list) | Agents need programmatic schedule management to complete the self-orchestration loop | Accepted |
...
- Schedule Registry with CRUD operations
...
### Phase 3: Recovery and Reliability (Week 4)
...
- [Orchestrator Design](orchestrator-design.md) - Workflow execution engine
- [Hook System](../DESIGN_OVERVIEW.md) - Event system integration
- [Diagnostics Design](diagnostics-design.md) - Observability integration
...
| v0.2 | 2026-03-06 | Parameterized Scheduling: added ParameterSchema (JSON Schema) for workflow parameter validation, parameter resolution order (defaults -> static -> dynamic), schedule cloning, agent-facing meta-tools (schedule_create, schedule_list), parameterized flight monitoring example. Part of Agent Autonomy system (ref: agent-autonomy-design.md). |
