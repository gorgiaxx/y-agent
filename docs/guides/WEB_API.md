...
> [!WARNING]
> The Web API is currently in development. The following features are **not yet implemented**:

- **Authentication** — No API key or token-based auth middleware
- **Streaming** — Responses are synchronous; no SSE/WebSocket streaming for chat
- **Rate Limiting** — No request throttling
- **CORS** — No CORS headers configured (browser clients will be blocked)
